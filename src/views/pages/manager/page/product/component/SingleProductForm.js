...
function SingleLessonForm({ product, onSubmit }) {
  ...
  const handleChangeAvt = (e, setFieldValue) => {
    if (e.target.files[0]) {
  ...
  const handleAddImage = (e, imgURLs, setFieldValue) => {
    if (e.target.files[0]) {
      const tempImgLink = URL.createObjectURL(e.target.files[0]);
      const tempURLs = [...imgURLs, tempImgLink];
            ...
            <div className="common-infomation-wrapper">
              ...
              <Grid container spacing={4}>
                <Grid className="single-lesson-form" item xs={12} md={5}>
                  ...
                  <div className="input-field">
                    <label htmlFor="sellPrice">Giá bán trước khuyến mãi</label>
                ...
                <Grid className="lesson-video-views" item xs={12} md={6}>
                  <div className="input-field">
                    ...
                    <label htmlFor="avtURL">
                      <span className="lw-btn">Tải ảnh lên</span>
                    </label>
                    <div style={{ width: "5px", height: "8px" }}></div>
                    <input
                      id="avtURL"
                      style={{ display: "none" }}
                      type="file"
                      onChange={(e) => handleChangeAvt(e, setFieldValue)}
                    />
                    <img
                        ...
                        <span
                          ...
                          onClick={() => {
                            ...
                            if (values.foods.includes(item)) {
                              tempValue = values.foods.filter((e) => e != item);
                            } else {
