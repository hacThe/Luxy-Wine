...
function UploadModal(props) {
    ...
    const handleUpload = () => {
        firebaseStorageServices.uploadFileToFirebase(file, 'file', handleSnapshot, handleError, handleUrlRespone);
    };
