                    ...
                    <div className="shipment-detail-form">
                        <div className="form-item">
                            ...
                            {props.errors.fullname && props.touched.fullname && (
                                <p className="input-error-validation"> {props.errors.fullname} </p>
                            )}
                        </div>
                        ...
                        <div className="address-group">
                            ...
                            <div className="input-field">
                                ...
                                >
                                    ...
                                    {renderOptionList(
                                        subVn.getDistrictsByProvinceCode(props.address.province?.code)
                                    )}
                                </select>
                            </div>
                            ...
                            <div className="input-field">
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        if (props.address.province.code && props.address.district.code && JSON.parse(e.target.value).code) {
                                            props.address.setAddressError('');
                                        }
                                        if (e.target.value) props.address.setWard(JSON.parse(e.target.value));
                                    }}
                                    name="ward"
                                >
